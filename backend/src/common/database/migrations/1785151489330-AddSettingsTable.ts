...
export class AddSettingsTable1785151489330 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "favoris_categorie" RENAME COLUMN "category_id" TO "categorie_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favoris_categorie" RENAME CONSTRAINT "PK_eced567ae62fc80d8caa9259cde" TO "PK_18add9a3ba9dcfad0f6867c3e80"`,
    );
    await queryRunner.query(
      `ALTER TABLE "article" RENAME COLUMN "category_id" TO "categorie_id"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favoris_categorie" ADD CONSTRAINT "FK_9c49d7a2363c83791e2db309f64" FOREIGN KEY ("categorie_id") REFERENCES "categorie"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "article" ADD CONSTRAINT "FK_115bb330eb4250fa89ee1578e37" FOREIGN KEY ("categorie_id") REFERENCES "categorie"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "article" DROP CONSTRAINT "FK_115bb330eb4250fa89ee1578e37"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favoris_categorie" DROP CONSTRAINT "FK_9c49d7a2363c83791e2db309f64"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "favoris_categorie" RENAME CONSTRAINT "PK_18add9a3ba9dcfad0f6867c3e80" TO "PK_eced567ae62fc80d8caa9259cde"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favoris_categorie" RENAME COLUMN "categorie_id" TO "category_id"`,
    );
    await queryRunner.query(

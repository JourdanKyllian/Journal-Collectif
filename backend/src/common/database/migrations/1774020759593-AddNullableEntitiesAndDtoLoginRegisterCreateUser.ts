...
export class AddNullableEntitiesAndDtoLoginRegisterCreateUser1774020759593 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`declaration_objet\` CHANGE \`description\` \`description\` text NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`image_article\` CHANGE \`legend\` \`legend\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`image_article\` CHANGE \`legend\` \`legend\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`image_article\` ADD CONSTRAINT \`FK_9b1dc91da0a7bb0a2e109a501b3\` FOREIGN KEY (\`article_id\`) REFERENCES \`article\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`declaration_objet\` CHANGE \`description\` \`description\` text NULL DEFAULT 'NULL'`);

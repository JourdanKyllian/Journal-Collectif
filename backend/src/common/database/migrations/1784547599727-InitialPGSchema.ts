...
export class InitialPGSchema1784547599727 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "role" ("id" SERIAL NOT NULL, "libelle" character varying(50) NOT NULL, CONSTRAINT "PK_b36bcfe02fc8de3c57a8b2391c2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "auteur_article" ("user_id" integer NOT NULL, "article_id" integer NOT NULL, "role_contribution" character varying(100), "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_35ecd7e1910e1adca654153a4ea" PRIMARY KEY ("user_id", "article_id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "vue_statistique" DROP CONSTRAINT "FK_9a8c0b8326fa0073f83133bac73"`,
    );
    await queryRunner.query(
      `ALTER TABLE "vue_statistique" DROP CONSTRAINT "FK_927515d747571dec8fac9740056"`,
    );
    await queryRunner.query(
      `ALTER TABLE "article" DROP CONSTRAINT "FK_cdd234ef147c8552a8abd42bd29"`,
    );
    await queryRunner.query(
      `ALTER TABLE "image_article" DROP CONSTRAINT "FK_9b1dc91da0a7bb0a2e109a501b3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favoris_categorie" DROP CONSTRAINT "FK_bb461f09e7eb7e66ec8f1acbdcd"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favoris_categorie" DROP CONSTRAINT "FK_92e92b1eabd4bdb5d6fc203b69f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_a2cecd1a3531c0b041e29ba46e1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auteur_article" DROP CONSTRAINT "FK_34c8a3df9a057d4031985b9e6e2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auteur_article" DROP CONSTRAINT "FK_2588026124b2b67d08e9ac70ce4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "declaration_objet" DROP CONSTRAINT "FK_fa23c683df53e3f2dbd33d3370e"`,
    );

      ...
      <DialogContent className="sm:max-w-115 bg-blanc border-champagne/30 rounded-3xl p-8 shadow-2xl overflow-hidden flex flex-col gap-0">
        ...
        <Tabs defaultValue="login" className="w-full flex flex-col">
          ...
          <TabsContent value="register" className="w-full m-0 focus-visible:outline-none space-y-4">
             <Input placeholder="Nom complet" className="h-13 px-4 border-champagne/40 rounded-xl" />
             <Input type="email" placeholder="Email" className="h-13 px-4 border-champagne/40 rounded-xl" />
             <Input type="password" placeholder="Mot de passe" className="h-13 px-4 border-champagne/40 rounded-xl" />
             <Button className="w-full h-13 bg-noir text-blanc font-montserrat font-black rounded-xl">
               Créer un compte
             </Button>
          </TabsContent>
        </Tabs>
